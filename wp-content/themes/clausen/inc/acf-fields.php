	...
	acf_add_local_field_group( [
		...
		'fields'   => [
			...
			[
				...
				'label'        => 'Household membership price ($)',
				'name'         => 'price_family',
				'type'         => 'number',
				'default_value' => 100,
				'min'          => 0,
				'instructions' => 'Annual price for Household membership (PMPro level 2).',
			],
			[
				'key'          => 'field_price_student',
				'label'        => 'Student / Senior membership price ($)',
				'name'         => 'price_student',
				'type'         => 'number',
				'default_value' => 25,
				'min'          => 0,
				'instructions' => 'Annual price for Student / Senior membership (PMPro level 3).',
			],
			[
				'key'          => 'field_price_benefactor',
				'label'        => 'Benefactor minimum price ($)',
				'name'         => 'price_benefactor',
				'type'         => 'number',
				'default_value' => 1000,
				'min'          => 0,
				'instructions' => 'Minimum annual gift for Benefactor membership (PMPro level 4). Benefactors may choose to give more at checkout.',
			],
	...
	acf_add_local_field_group( [
		...
		'fields'   => [
			...
			[
				...
				'instructions' => 'One row per tier: Individual, Household, Student/Senior, Benefactor. Order must match PMPro levels 1–4.',
				'sub_fields'   => [
					[
