...
function tclas_register_acf_fields(): void {
	...
	acf_add_local_field_group( [
		...
		'fields'   => [
			...
			[
				'key'           => 'field_hero_photo_msp',
				'label'         => 'Hero photo — Minneapolis',
				'name'          => 'hero_photo_msp',
				'type'          => 'image',
				'return_format' => 'array',
				'preview_size'  => 'medium',
				'instructions'  => 'Left half of the split hero. Recommended: 1200×800px landscape. A vibrant Minneapolis scene.',
			],
			[
				'key'          => 'field_hero_photo_msp_credit',
				'label'        => 'Minneapolis photo credit',
				'name'         => 'hero_photo_msp_credit',
				'type'         => 'text',
				'placeholder'  => 'e.g. Photo: Jane Smith',
				'instructions' => 'Displayed as a small overlay on the photo. Include the "Photo:" prefix.',
			],
			[
				'key'           => 'field_hero_photo_lux',
				'label'         => 'Hero photo — Luxembourg City',
				'name'          => 'hero_photo_lux',
				'type'          => 'image',
				'return_format' => 'array',
				'preview_size'  => 'medium',
				'instructions'  => 'Right half of the split hero. Recommended: 1200×800px landscape. Luxembourg City or Moselle countryside.',
			],
			[
				'key'          => 'field_hero_photo_lux_credit',
				'label'        => 'Luxembourg photo credit',
				'name'         => 'hero_photo_lux_credit',
				'type'         => 'text',
