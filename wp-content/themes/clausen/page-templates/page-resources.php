...
<section class="tclas-section">
	<div class="container-tclas">
		...
		<?php if ( ! tclas_is_member() ) : ?>
			...
			<div class="tclas-member-gate">
				<div class="tclas-member-gate__inner">
					...
					<p>
						<?php esc_html_e( 'The resources library — documents, citizenship guides, and genealogy tools — is available to TCLAS members.', 'tclas' ); ?>
					</p>
		...
		<?php else : ?>
			...
			<!-- Page content (editor-managed resource sections) -->
